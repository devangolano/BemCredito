        ...
        <nav className="py-4 bg-white border-b border-gray-200">
            ...
            {isMenuOpen && (
                <div className="lg:hidden mt-4 px-4">
                        <DropdownMenu.Root>
                            <DropdownMenu.Trigger asChild>
                                <button className="text-gray-700 flex items-center gap-x-2 hover:text-green-500 focus:outline-none">
                                    Empréstimos
                    ...
                    <div className="flex flex-col mt-2 space-y-2">
                        ...
                        <button className="bg-green-500 mb-8 py-1 px-4 rounded-full hover:bg-green-400">
                            Meu pedido
                        </button>
                        <button className="bg-green-500 py-1 px-4 rounded-full hover:bg-green-400">
                            Central de ajuda
